...
function Men(props) {
    ...
    useEffect(() => {
        ...
        axios.get(constants.API_URL + 'products/getall?type=mendress')
            .then(res => {
    ...
    useEffect(() => {
        setName(Session.getName)
        axios.get(constants.API_URL + 'products/getall?type=menshoes')
            .then(res => {
                console.log(res.data)
                setShoes(res.data)
            }).catch(err => console.log(err))
                                ...
                                <div className="card-body">
                                    ...
                                    <form >
                                        <div className="form-group">
                                            <input type="number" min="0" onChange={(e) => setQuantity(e.target.value)} className="form-control" placeholder="Enter quantity" />
                                        </div></form>
                                    <br /> <br />
